...
export default function AlternativeBentoSection() {
    return (
        <section className="py-16 md:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-5xl px-6">
                <div className="mb-16 text-center">
                    <h2 className="font-mono text-balance text-3xl font-semibold md:text-4xl lg:text-5xl">Advanced Features</h2>
                    <p className="font-mono mt-4 mx-auto max-w-2xl text-muted-foreground">Discover powerful tools and integrations to enhance your development workflow.</p>
                </div>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        ...
                        <div className="relative h-fit pl-6 md:pl-12">
                            ...
                            <div className="bg-background overflow-hidden rounded-tl-lg border-l border-t pl-2 pt-2 dark:bg-zinc-950">
                                <Image
                                    src="/hero-section-screenshot-dark.png"
                                    className="hidden dark:block"
                                    alt="Hero section screenshot dark mode"
                                    width={1207}
                                    height={929}
                                />
                                <Image
                                    src="/hero-section-screenshot.png"
                                    className="shadow dark:hidden"
                                    alt="Hero section screenshot light mode"
                                    width={1207}
                                    height={929}
                                />
                            </div>
