-- Drop and recreate the sessions summary function to return 'title' instead of 'name'
-- This matches the expected SessionWithSummary interface and fixes Magic Ads titles

DROP FUNCTION IF EXISTS get_sessions_with_summary(UUID, TEXT, BOOLEAN, TEXT, INTEGER, INTEGER);
